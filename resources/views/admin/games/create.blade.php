        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">{{ __('create game') }}</h1>
            ...
            <div class="card-body">
                <form action="{{ route('admin.games.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datetime" id="start_time" placeholder="{{ __('start_time') }}" name="start_time" value="{{ old('start_time') }}" />
                    </div>
                    <div class="form-group">
                        <label for="result1">{{ __('result1') }}</label>
                        <input type="number" class="form-control" id="result1" placeholder="{{ __('result1') }}" name="result1" value="{{ old('result1') }}" />
                    </div>
                    <div class="form-group">
                        <label for="result2">{{ __('result2') }}</label>
                        <input type="number" class="form-control" id="result2" placeholder="{{ __('result2') }}" name="result2" value="{{ old('result2') }}" />
                    </div>
